...
export function AppShell({ children, siteHost }: { children: ReactNode; siteHost: string }) {
  ...
  return <div className="min-h-screen">
    <div className="no-print bg-rose/20 px-4 py-2.5 text-center text-xs font-semibold text-charcoal">See the actual paid PDF and workbook before checkout. <Link href={site.product} className="ml-1 font-bold underline underline-offset-4">Look inside the files →</Link></div>
