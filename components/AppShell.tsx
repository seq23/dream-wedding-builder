...
export function AppShell({ children, siteHost, directory = [] }: { children: ReactNode; siteHost: string; directory?: DirectoryLink[] }) {
  ...
  return <div className="min-h-screen">
    ...
    <PlannerCtaProvider plannerAbsolute={siteHost !== 'weddingchecklistpdf.com'}><main className="mx-auto max-w-[1440px] px-4 py-6 md:px-6 md:py-10">{children}</main></PlannerCtaProvider>
