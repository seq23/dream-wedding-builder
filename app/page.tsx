  ...
  <section className="overflow-hidden rounded-[2rem] border border-charcoal/10 bg-white shadow-[0_30px_90px_rgba(78,62,49,.12)]">
    <div className="grid lg:grid-cols-[.82fr_1.18fr]">
      <div className="flex flex-col justify-center p-6 md:p-10 lg:p-12 xl:p-16">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2"><Link className="inline-flex min-h-14 items-center justify-center rounded-2xl bg-charcoal px-6 py-4 text-center font-bold text-linen shadow-lg transition hover:-translate-y-0.5" href="/free-wedding-planner">Build my wedding free →</Link><Link className="inline-flex min-h-14 items-center justify-center rounded-2xl border border-charcoal/20 bg-white px-6 py-4 text-center font-bold transition hover:bg-linen" href="/products/operations-suite">Get all four wedding tools — $39</Link></div>
        <p className="mt-3 text-sm text-charcoal/55">Save $13 with the complete suite. One-time purchase.</p>
        <div className="mt-5 grid gap-2 text-sm sm:grid-cols-2">
          <Link href="https://weddingseatingchartmaker.com/products/seating-chart-maker" className="rounded-xl border border-charcoal/10 bg-linen/70 px-4 py-3 font-bold transition hover:border-charcoal/25 hover:bg-linen">Wedding Seating Chart Maker — $19</Link>
          <Link href="https://weddingbudgetspreadsheet.com/products/budget-spreadsheet" className="rounded-xl border border-charcoal/10 bg-linen/70 px-4 py-3 font-bold transition hover:border-charcoal/25 hover:bg-linen">Wedding Budget Spreadsheet — $12</Link>
          <Link href="https://weddingtimelinetemplate.com/products/timeline-template" className="rounded-xl border border-charcoal/10 bg-linen/70 px-4 py-3 font-bold transition hover:border-charcoal/25 hover:bg-linen">Wedding Timeline Template — $12</Link>
          <Link href="/products/checklist-pdf" className="rounded-xl border border-charcoal/10 bg-linen/70 px-4 py-3 font-bold transition hover:border-charcoal/25 hover:bg-linen">Wedding Checklist PDF — $9</Link>
        </div>
